...
public class CreateUser implements Serializable {
    ...
    public CreateUser(String storeId, String storePw, String idPw, String taxNo, String email, String taxNoEmail, String idTaxNoEmail, String phone, String category, String storeName, int floor, String logo, String storeNameCategory) {
        this.storeId = storeId;
        this.storePw = storePw;
        this.idPw = idPw;
        this.taxNo = taxNo;
